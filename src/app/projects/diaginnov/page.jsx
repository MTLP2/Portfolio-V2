...
export default function Page() {
  ...
  const imageUrls = [
    "/diaginnov/diaginnov1.png",
    "/diaginnov/diaginnov2.png",
    "/diaginnov/diaginnov3.png",
    "/diaginnov/diaginnov4.png",
  ];
    ...
    <div className="bg-[#ecebeb] dark:bg-[#121212] dark:text-white">
      <SmoothScrool>
        ...
        <div className="relative h-[50vh] md:h-[110vh] z-10">
          <video
            ref={videoRef}
            src="https://mathlpbucket.s3.eu-west-3.amazonaws.com/diagInnov.mov" // Changez le fichier à un format compatible, comme .mp4
            width="100%"
            height="100%"
            loop
            muted
            className="w-full object-contain absolute bg-gradient-to-b from-[#00b64f  ]  md:h-full top-0 left-0"
          ></video>
        </div>
      </SmoothScrool>
