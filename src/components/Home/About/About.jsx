      ...
      <div className="w-full flex gap-6 flex-col lg:flex-row items-center justify-center">
        <div className="flex flex-col gap-4 md:w-[45%] xl:w-[45%]">
          <div className="flex items-center gap-4">
            <h2 className="text-2xl font-Tropical font-black dark:text-gray-100">
              Qui suis-je ?{" "}
            </h2>
        ...
        <div className="relative flex md:w-[500px] xl:w-[400px] ">
          ...
          <motion.img
            ...
            className=" w-full object-cover md:w-[400px] lg:w-full xl:w-[500px]  md:grayscale hover:grayscale-0 rounded-xl shadow-xl hover:shadow-2xl transition-shadow h-[500px] z-20"
          />
        </div>
      </div>
      <div>
